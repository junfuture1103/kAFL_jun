...
#ifdef QEMU_DEBUG
	debug("pt_pre_kvm_run() called.");
#endif

#ifdef CONFIG_REDQEEN
	...
	if (cpu->pt_cmd){
		switch(cpu->pt_cmd){
			...
			case KVM_VMX_PT_CONFIGURE_ADDR3:
				#ifdef QEMU_DEBUG
				debug("cpu->pt_fd: KVM_VMX_PT_CONFIGURE_ADDR");
				#endif
			...
			case KVM_VMX_PT_ENABLE_ADDR3:
				#ifdef QEMU_DEBUG
				debug("cpu->pt_fd: KVM_VMX_PT_ENABLE_ADDR");
				#endif
			...
			case KVM_VMX_PT_CONFIGURE_CR3:
				#ifdef QEMU_DEBUG
				debug("cpu->pt_fd: KVM_VMX_PT_CONFIGURE_CR3");
				#endif
			...
			case KVM_VMX_PT_ENABLE_CR3:
				#ifdef QEMU_DEBUG
				debug("cpu->pt_fd: KVM_VMX_PT_ENABLE_CR3");
				#endif
