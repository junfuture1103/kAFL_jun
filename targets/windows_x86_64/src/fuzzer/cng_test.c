...
kAFL_IRP constraints[] = {
	{0x390004, 0, 0xffff, 0xffff},
    {0x390008, 0, 0xffff, 0xffff},
    {0x39000E, 0, 0xffff, 0xffff},
    {0x390012, 0, 0xffff, 0xffff},
    {0x390016, 0, 0xffff, 0xffff},
    {0x39001A, 0, 0xffff, 0xffff},
    {0x39001E, 0, 0xffff, 0xffff},
    {0x390022, 0, 0xffff, 0xffff},
    {0x390024, 0, 0xffff, 0xffff},
    {0x390044, 0, 0xffff, 0xffff},
    {0x390048, 0, 0xffff, 0xffff},
    {0x390064, 0, 0xffff, 0xffff},
    {0x390073, 1, 0xffff, 0xffff},
    {0x390074, 4, 4, 0xffff},
    {0x39007a, 0, 0xffff, 0xffff},
    {0x39007e, 0, 0xffff, 0xffff},
    {0x390400, 0, 0xffff, 0xffff}
};
...
int main(int argc, char** argv)
{
    ...
    kafl_vuln_handle = CreateFile((LPCSTR)"\\\\.\\GLOBALROOT\\Device\\Cng",
