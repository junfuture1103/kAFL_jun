...
kAFL_IRP constraints[] = {
	...
	{0x80102040,0x1,0xffff,0xffff},
	{0x80102044,0x1,0xffff,0xffff},
	{0x80102050,0x1,0xffff,0xffff},
	{0x80102054,0x1,0xffff,0xffff}
...
int main(int argc, char** argv)
{
    ...
    kafl_vuln_handle = CreateFile((LPCSTR)"\\\\.\\MsIo",
    ...
    hprintf("[-] Success get device handle!\n");
